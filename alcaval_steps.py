...
steps['RunHLTPhysics22D_v1']={'INPUT':InputInfo(dataSet='/HLTPhysics/Run2022D-v1/RAW',ls={357612: [[1,100]]})}
steps['RunMuon22D_v1']={'INPUT':InputInfo(dataSet='/Muon/Run2022D-v1/RAW',ls={357899: [[1,50]]})}
steps['RunJetMET22D_v1']={'INPUT':InputInfo(dataSet='/JetMET/Run2022C-v1/RAW',ls={357442: [[1,50]]})}
